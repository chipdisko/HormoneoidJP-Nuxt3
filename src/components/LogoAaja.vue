<template>
  <svg data-v-4a0d3e66="" version="1.1" id="headerlogo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 181.4 299.6" style="enable-background:new 0 0 181.4 299.6;" xml:space="preserve" class=""><path data-v-4a0d3e66="" d="M69.7,102.6c0,0-1-5.1,10.1-9.2c10.6-4,33.8-6.8,32.9-31.5c-0.2-4.6,1.3-9.1,4.4-12.6c0.1-0.1,2.8-3.6,2.9-3.8
    ...
    c22.2-17.8,18.8-37.3,8.4-53c-10.4-15.7-40.2-28.5-60.3-14.5c-20.1,14.1-37.4,10.3-37.4,10.3S69.9,107.9,69.7,102.6z"></path></svg>
</template>