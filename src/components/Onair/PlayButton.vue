...
<template>
  <button @click="handlePlay" class="border-white border hover:bg-orange-600 rounded-full flex items-center justify-center h-20 w-20 text-5xl text-white opacity-90 drop-shadow-md" :disabled="isDisabled" >
